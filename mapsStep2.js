...
// Step 2: Desktop Working + Mobile-Aware DOM Timing

alert('🚀 LibMaps Step 2 Starting!');
...
// STEP 1: Emergency debug system for mobile
...
// ===== FROM HERE DOWN: EXACT COPY OF mapsOld.js WITH STEP 2 MOBILE TIMING CHANGES =====
...
var springyILS = {
    ...
    scrapeDetailRows: function(items) {
        ...
        // STEP 2 ENHANCEMENT: Additional mobile selectors
        var selectors = [
        ...
        // STEP 2 ENHANCEMENT: Add more mobile-specific selectors
        if (isMobileDevice) {
            selectors.push(
...
var springyMap = {
    ...
    // STEP 2 ENHANCEMENT: Mobile-Aware DOM Timing
    watch: function() {
        debugLog("Starting DOM watcher");
        
        var attempts = 0;
        // STEP 2: Mobile-specific timing parameters
        ...
        var watcher = setInterval(function() {
            ...
            // STEP 2: Enhanced mobile selector strategy
            ...
            // STEP 2: Additional mobile fallback selectors
            ...
            if (targetElement) {
                ...
                // STEP 2: Longer render delay for mobile to ensure rendering is complete
                ...
                // STEP 2: Longer fallback delay for mobile
